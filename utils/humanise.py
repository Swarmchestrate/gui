...
def humanise_resource_type(resource_type):
    resource_types_humanised = {
        ...
        "application_raw_metric": "raw metric",
        "application_composite_metric": "composite metric",
        "application_reconfiguration": "reconfiguration policy",
...
def humanise_resource_type_plural(resource_type):
    resource_types_humanised = {
        ...
        "application_raw_metric": "raw metrics",
        "application_composite_metric": "composite metrics",
        "application_reconfiguration": "reconfiguration policies",
