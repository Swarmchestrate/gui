...
urlpatterns = [
    path('new-cloud-capacity/', views.CloudCapacityEditorStartTemplateView.as_view(), name='new_cloud_capacity'),
    path('new-cloud-capacity/<field_format>/', views.CloudCapacityEditorFormView.as_view(), name='new_cloud_capacity'),
    path('new-edge-capacity/', views.EdgeCapacityEditorStartTemplateView.as_view(), name='new_edge_capacity'),
